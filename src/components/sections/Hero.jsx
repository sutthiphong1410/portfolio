          ...
          <div className="flex flex-col items-center justify-center">
            <div className="max-w-xl text-center space-y-6 px-4">
              ...
              <p className="text-gray-500 leading-relaxed">
                I build clean, responsive, and interactive websites. Need one?
                I'm open to freelance work. Let's connect!
              </p>

              <div className="flex justify-center items-center gap-4 text-sm pt-4">
                <Link
                  href={""}
                  className="px-6 py-2.5 bg-primary rounded-full text-white hover:scale-110 duration-300 active:scale-100  flex gap-2 items-center justify-center"
                >
