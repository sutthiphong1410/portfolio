      ...
      <div className="w-full">
        ...
        <div className="max-w-5xl mx-auto p-6 text-gray-500 flex justify-between">
          <div>
            ...
            <p className="text-sm text-gray-400">© 2026 Sutthiphong Wongsaart. All rights reserved.</p>
          </div>
          <div>
            <div className="flex gap-4 mt-4">
               <div className="bg-gray-600 p-3 rounded-full hover:bg-purple-500 transition-colors cursor-pointer">
